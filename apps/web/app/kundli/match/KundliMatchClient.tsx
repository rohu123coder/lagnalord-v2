    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        ...
        <button
          ...
          className="mt-6 rounded-xl bg-gradient-to-r from-[#b18d4f] to-[#C8AC80] px-6 py-3 text-sm font-semibold text-[#09142a] shadow-md disabled:cursor-not-allowed disabled:opacity-60 hover:opacity-95"
        >
          Match Kundli
        </button>
