            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  disabled={loading}
                  className="flex-1 rounded-xl bg-gradient-to-r from-[#b18d4f] to-[#C8AC80] px-3 py-3 text-sm font-semibold text-[#09142a] shadow-md transition hover:opacity-95 disabled:opacity-60"
                >
