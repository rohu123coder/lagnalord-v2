          ...
          <div className="mx-auto grid max-w-[1200px] gap-8 px-4 py-12 md:grid-cols-2 md:px-8 md:py-16">
            ...
            <div className="rounded-2xl border border-[#b18d4f]/20 bg-[#0E1C3B] p-6 md:p-7">
              ...
              >
                ...
                <button
                  type="submit"
                  className="inline-flex w-full items-center justify-center rounded-full bg-[#b18d4f] hover:bg-[#8E713F] hover:text-white px-5 py-3 text-sm font-semibold text-[#09142a] transition hover:opacity-95 md:w-auto"
                >
                  Send Message
                </button>
              </form>
