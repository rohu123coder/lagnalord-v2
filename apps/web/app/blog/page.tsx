    ...
    <div className="min-h-screen text-[#F5F1E8]">
      ...
      <main className="border-b border-[#b18d4f]/20">
        <div className="mx-auto max-w-[1200px] px-4 py-16 text-center md:px-8 md:py-24">
          ...
          <Link
            href="/"
            className="mt-8 inline-flex rounded-full bg-gradient-to-r from-[#b18d4f] to-[#C8AC80] px-5 py-3 text-sm font-semibold text-[#09142a] transition hover:opacity-95"
          >
            Back to Home
          </Link>
        </div>
