    ...
    <div className={className}>
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="rounded-full bg-[#b18d4f] hover:bg-[#8E713F] hover:text-white px-4 py-2 text-sm font-semibold text-[#09142a] shadow-sm transition hover:opacity-95"
        >
          Recharge
        </button>
      </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-end justify-center bg-black/40 p-4 sm:items-center">
          ...
          >
            ...
            <button
              ...
              className="mt-5 w-full rounded-xl bg-[#b18d4f] hover:bg-[#8E713F] hover:text-white py-3 text-sm font-semibold text-[#09142a] shadow-md transition hover:opacity-95 disabled:opacity-60"
            >
