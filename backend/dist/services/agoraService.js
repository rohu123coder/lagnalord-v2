...
export function generateAgoraToken(channelName, uid, role = "publisher") {
    ...
    return RtcTokenBuilder.buildTokenWithUid(APP_ID, APP_CERTIFICATE, channelName, uid, rtcRole, expiryTime, expiryTime);
}
export function generateChannelName(sessionId) {
