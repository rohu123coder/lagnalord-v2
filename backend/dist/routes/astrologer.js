...
function formatDobForKundali(value) {
    if (value == null)
        return null;
...
function formatTimeForKundali(value) {
    if (value == null)
        return undefined;
 ...
 */
router.get("/sessions/:sessionId/customer-kundli", async (req, res) => {
    ...
    try {
        const sessionResult = await query(`SELECT cs.user_id,
        ...
        const utcOffset = session.birth_utc_offset != null
        ...
        const msg = e instanceof Error ? e.message : "Kundali calculation failed";
